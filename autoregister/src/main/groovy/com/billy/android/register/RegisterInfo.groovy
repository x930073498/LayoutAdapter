...
class RegisterInfo {
    ...
    //以下是可配置参数
    String interfaceName = 'com.x930073498.Register'
    ArrayList<String> superClassNames = []
    String initClassName = 'com.x930073498.RegisterRepository'
    String initMethodName = ''
    String registerClassName = 'com.x930073498.RegisterRepository'
